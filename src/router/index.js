    ...
    children: [
      {
        path: 'procesos',
        name: 'procesos',
        component: () => import('@/views/procesos/listprocesos/index'),
        meta: { title: 'Procesos Activos', icon: 'form'},
      },
      {
        path: 'participantes',
        name: 'participantes',
        component: () => import('@/views/procesos/listparticipantes/index'),
        meta: { title: 'Participantes', icon: 'form'},
        hidden: true
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: 'Gestion de Procesos', icon: 'form' }
      },
      {
        path: 'nuevo_censo',
        name: 'nuevo_censo',
        component: () => import('@/views/gestionCensos/newCenso/index'),
        meta: { title: 'Nuevo proceso', icon: 'form' },
        hidden: true
      }
    ]
  },
